...
//  OpenMarket
//
//  Created by unchain, hyeon2 on 2022/07/26.
//
...
enum Metric {
    ...
    static let itemCount: Int = 20
    
    static let stackViewSpacing: CGFloat = 10
    static let listPositiveConstant: CGFloat = 5
    static let listNegativeConstant: CGFloat = -5
    ...
    static let listGroupHeight: CGFloat = 0.15
